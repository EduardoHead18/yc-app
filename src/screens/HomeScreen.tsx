import {
  ...
  export const HomeScreen = () => {
            ...
            <View style={styles.cardContainer}>
              ...
              />
                    ...
                    <View style={styles.textCard}>
                      ...
                      <Text style={[styles.textDescriptionsCard,{fontWeight:'bold'}]}> $ {item.price}</Text>
    ...
    return (
      <SafeAreaView
        style={{ width: windowWidth * 0.9, alignSelf: "center", marginTop: windowHeight*0.07 }}
      >
